# Lottery-Project
It's a Lottery  project using Chain Link Keepers and VRF.
...
```
git clone https://github.com/RodrigoAmorim954/Lottery-Project
cd Lottery-Project
yarn
```
## Initial Setup
...
- `GOERLI_RPC_URL`: This is url of the goerli testnet node you're working with. You can get setup with one for free from [Alchemy](https://alchemy.com/?a=673c802981) or Infura [Infura](https//infura.io).

2. Get testnet ETH (Goerli TestNet)
